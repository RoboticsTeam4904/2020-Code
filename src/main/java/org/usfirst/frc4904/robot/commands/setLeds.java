...
public class setLeds {
    ...
    public setLeds(String name, int id) {
        // arr1 needs to tell us if there is a custom color, they are ready to shoot, in
        // shooting zone, and the alliance color
        arr1 = new byte[] { 1, 0, 0, 0, 0, 0, 0, 0 };
        ...
        // use
        // https://first.wpi.edu/FRC/roborio/release/docs/java/edu/wpi/first/hal/can/CANJNI.html#FRCNetCommCANSessionMuxSendMessage(int,byte%5B%5D,int)
        // in the future
